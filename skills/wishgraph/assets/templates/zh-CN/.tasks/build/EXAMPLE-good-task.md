...
- [ ] 如果完成 roadmap item，更新 `PRD.md` progress。
- [ ] 如果 anchors 或状态变化，更新 `CODEMAP.md`。
- [ ] `reports/DEV_REPORT.md` 记录 test output。
- [ ] `prompts/DISCUSSION_AI.md` 更新当前进度和下一个任务。
...
报告修改文件、运行测试、手动检查结果、记忆更新、commit hash 和剩余风险。
