...
- Update affected PRD, architecture, CODEMAP, and conventions only when integrated project truth changed.
- Keep role prompts stable. Current user-readable state belongs only in `reports/PROJECT_STATUS.md`.
