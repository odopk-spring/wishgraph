...
The Discussion-local Integration phase reviews this file after absorbing Worker reports and updates it only when integrated feature status, anchors, contracts, probes, or validation surfaces changed.
