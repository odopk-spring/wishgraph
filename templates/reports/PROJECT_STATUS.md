...
This file is the current integrated project snapshot, not an append-only history. The Integration AI rewrites it after each integration. Detailed execution history remains in `reports/runs/*.md` and Git.
